...
std::any LlvmBuilder::visitInt(codegen::TParser::IntContext *ctx) {
    auto i = ctx->INT();
    std::int32_t val = std::stoi(i->getText());
    return static_cast<llvm::Value*>(llvm::ConstantInt::get(*llvm_context_, llvm::APInt(32, val)));
}

std::any LlvmBuilder::visitIdent(codegen::TParser::IdentContext *ctx) {
...
std::any LlvmBuilder::visitFlowControl(codegen::TParser::FlowControlContext *ctx) {
...
llvm::AllocaInst* LlvmBuilder::CreateEntryBlockAlloca(llvm::Function *function,
...
std::any LlvmBuilder::visitAssign(codegen::TParser::AssignContext *ctx) {
...
std::any LlvmBuilder::visitCond(codegen::TParser::CondContext *ctx) {
...
std::any LlvmBuilder::visitBinaryOp(codegen::TParser::BinaryOpContext *ctx) {
...
std::any LlvmBuilder::visitReturn(codegen::TParser::ReturnContext *ctx) {
  llvm::Value* val = std::any_cast<llvm::Value*>(visit(ctx->expr()));
  ir_builder_->CreateRet(val);
  return nullptr;
}

const llvm::Module* LlvmBuilder::GetIr() const {
